...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init.th7.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.th7.rc
...
ifneq (,$(filter $(PRODUCT_DEVICE), venus mars))
PRODUCT_PACKAGES += \
...
$(call inherit-product, vendor/extra/extra.mk)
